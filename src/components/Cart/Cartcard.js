            ...
            <div class="w-full ml-0 text-left bg-gray-100 rounded-md overflow-hidden m-4 sm:flex sm:shadow-lg sm:hover:shadow-2xl sm:transition-shadow tracking-wide">
                ...
                <div class="mx-8 my-4">
                    ...
                    <div>
                        <p className="flex flex-col justify-items-center font-bold text-2xl  mb-2">
                            ...
                            <div className="flex mt-1 text-sm">
                                <span className="font-bold opacity-60 line-through ml-2">₹ {product?.price}</span>
                    ...
                    <div className="flex space-x-3 ">
                        ...
                        <button class="py-2 px-3 bg-gray-900 text-white  hover:bg-black hover:text-green-50 font-bold rounded-md mt-1 mb-2 focus:outline-none" onClick={() => dispatchToCart(handleRemoveFromCart(product))}>
                            Remove
                        </button>
                    </div>
                </div>
