...
const Header = () => {
  ...
  return (
    <div className="flex flex-col">
      <Breadcrumb />
      <div className="sticky top-0 mt-9 w-full mx-auto border-t border-gray flex-shrink-0 shadow-md h-14 flex p-9 text-3xl sm:w-full md-full">
        <div className="w-full flex items-center justify-between">
          ...
          <div className="flex p-6 space-x-6 justify-center items-center ">
            <div>
              <Link to="/shop">
                <button className="hidden sm:block text-lg p-2 w-full focus:text-blue-500 focus:outline-none">
                  SHOP
                </button>
              </Link>
            </div>
